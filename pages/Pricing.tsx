  ...
  const subscriptionPlans = [
    {
      ...
      monthlyPrice: 0,
      annualPrice: 0,
      description: 'Essai complet de 7 jours à l\'inscription (comme Élite), puis palier gratuit permanent.',
      features: [
        '7 premiers jours : accès complet, sans carte bancaire',
        'Ensuite : 1 candidature IA / mois',
